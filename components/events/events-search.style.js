export default {
    form: 'mt-8 mb-8 ml-auto mr-auto p-4 bg-white rounded-md w-11/12 max-w-screen-sm flex justify-between flex-col md:flex-row gap-4',
    controls: 'w-full md:w-4/5 flex gap-4 flex-col md:flex-row',
